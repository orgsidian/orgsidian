 ...
 *
 * STATUS: SCAFFOLD — passes via test.fixme until Story 7.1 lands the surface.
 *
 ...
 * downstream epics. When Story 7.1 lands, replace test.fixme with test,
...
test.describe('@a11y Today Dashboard', () => {
  test.fixme('keyboard-only happy-path + axe-core scan', async ({ page }) => {
    // TODO(Story 7.1): navigate to /today, perform a representative action
