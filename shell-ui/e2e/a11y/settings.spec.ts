/**
 * @a11y — Settings keyboard-only happy-path scenario (LD-58 gate #2 + #3).
 *
 * STATUS: SCAFFOLD — passes via test.fixme until Story 12.3 (keybinding
 * remap) / Story 12.1 (CSS loader) lands the surface.
 *
 ...
 * downstream epics. When Story 12.3 / Story 12.1 land, replace test.fixme
...
test.describe('@a11y Settings', () => {
  test.fixme('keyboard-only happy-path + axe-core scan', async ({ page }) => {
    // TODO(Story 12.3 / Story 12.1): navigate to /settings, perform a
